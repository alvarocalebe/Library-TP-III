...
namespace Library.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //    // Verifique se o usuário existe e se o e-mail está confirmado
        //    var user = await UserManager.FindByEmailAsync(model.Email);
        //    if (user != null && !await UserManager.IsEmailConfirmedAsync(user.Id))
        //    {
        //        ModelState.AddModelError("", "Você precisa confirmar seu e-mail antes de fazer login.");
        //        return View(model);
        //    }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            // Se o e-mail do usuário não for "admin@exemplo.com" e não estiver confirmado
            if (user != null && user.Email != "admin@exemplo.com" && !await UserManager.IsEmailConfirmedAsync(user.Id))
            {
                ModelState.AddModelError("", "Você precisa confirmar seu e-mail antes de fazer login.");
                return View(model);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["Message"] = "Para concluir o registro, verifique seu e-mail e confirme sua conta.";
